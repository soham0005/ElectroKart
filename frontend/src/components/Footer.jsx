    ...
    <>
      ...
      <div className="footer">
        ...
        <div>
          ...
          <div className='marge'>
            <button className='rateUs' onClick={() => setIsModalOpen(true)}>Rate Us</button>


            {isModalOpen && (
                        <div className="rating-model">
                            <div className="rating-body bg-white p-8 shadow-lg lg:w-[300px]">
                                <h2 className="text-xl font-bold mb-4 text-center head">Rate Us</h2>
                                <div className="flex justify-center stars">
                                    {[1, 2, 3, 4, 5].map((value) => (
                                        <span
                                            key={value}
                                            className={`cursor-pointer text-2xl ${rating >= value ? 'rated' : 'non-rated'}`}
                                ...
                                <textarea
                                    className=" width-full border p-2 mb-4"
                                    rows={4}
